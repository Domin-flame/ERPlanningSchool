...
export default function Settings() {
  ...
  const passwordRules = [
    { label: "8 caract̬res minimum", valid: newPassword.length >= 8 },
    ...
    { label: "Un caract̬re sp̩cial", valid: /[/*@#._!$%^&+=-]/.test(newPassword) },
  ];
          ...
          <div className="card">
            ...
            <div className="settings-row">
              <div>
                ...
                <p className="muted">Cette pr̩f̩rence est conserv̩e sur ce navigateur.</p>
              </div>
              <select
