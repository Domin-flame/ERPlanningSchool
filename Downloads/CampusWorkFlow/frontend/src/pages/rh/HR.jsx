...
// c'est une page importante car c'est le personnel du module rh qui sont chargé de valider les inscriptions autres que student sur la plateforme et gère la suppression, la modification d'un role, il peut faire changer de poste ou de département à une personne 
// il faut encore que je définisse clairement à quoi sert le module rh
  return (
    <div className="page-animate">
      <Breadcrumbs items={[{ label: "Accueil" }, { label: "Portail RH" }, { label: "Dashboard" }]} />
